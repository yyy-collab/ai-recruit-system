...
public interface InterviewMessageService {
    ...
    PageInfo<HrMessageListItemVO> getHrMessageList(Integer hrId, Integer status, int pageNum, int pageSize);

    HrMessageDetailVO getHrMessageDetail(Integer hrId, Integer messageId);

    PageInfo<SeekerMessageListItemVO> getSeekerMessageList(Integer seekerId, Integer status, int pageNum, int pageSize);
